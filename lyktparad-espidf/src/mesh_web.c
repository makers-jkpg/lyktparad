...
"<textarea id=\"importTextarea\" rows=\"8\" cols=\"80\" placeholder=\"Paste base64-encoded sequence data here...\"></textarea>"
"<div class=\"export-import-actions\">"
...
"  const importTextarea = document.getElementById('importTextarea');"
"  const importFeedback = document.getElementById('importFeedback');"
"  const base64 = importTextarea.value.trim();"
"  importFeedback.textContent = '';"
"  importFeedback.className = '';"
"  if (!base64) {"
"    importFeedback.textContent = 'Please paste base64-encoded sequence data';"
...
"    } catch (e) {"
"      importFeedback.textContent = 'Invalid base64 encoding';"
"      importFeedback.className = 'import-feedback-error';"
"      return;"
"    }"
...
"      return;"
"    }"
"    const importedTempo = bytes[0];"
"    if (importedTempo < 1 || importedTempo > 255) {"
"      importFeedback.textContent = 'Invalid tempo value: must be 1-255 (10-2550ms)';"
"      importFeedback.className = 'import-feedback-error';"
"      return;"
"    }"
